...
----
### 1. <a id="js_1">javaScript有哪些基本数据类型?</a>
----
...
----
### 2. <a id="js_2">javaScript有哪些常用的数据类型检测方法？</a>
----
...
----
### <a id="js_4">4. javaScipt中有哪些继承方式？</a>
----
> 1. 原型链继承
...
----
### <a id="js_5">5. 如何实现new、apply、call、bind方法？</a>
----
...
----
### <a id="js_9"><a id="js_3">9. 什么是作用域？</a>
----
